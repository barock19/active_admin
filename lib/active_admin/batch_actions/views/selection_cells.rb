...
module ActiveAdmin
  module BatchActions
    ...
    class ResourceSelectionCell < ActiveAdmin::Component
      ...
      def build(resource)
        input type: "checkbox", 'data-resource-id' => resource.id, id: "batch_action_item_#{resource.id}", value: resource.id, class: "collection_selection", name: "collection_selection[]"
      end
    end
